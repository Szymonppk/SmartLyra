export const RedStoneButton = ({ children, onClick, className = "" }) =>{
    ...
    const baseStyle = "h-[4vh] w-[18vh] border-2 border-red-600 text-black font-semibold text-[1.5vh] text-center rounded-md shadow-md hover:shadow-lg shadow-black/40 transition-transform hover:scale-95";
